...
class GradeService:
    ...
    def __transform_repository_data_to_dictionary_with_keys_student_id_and_discipline_id(self):
        """
        we make this transformation to be easier to work with the data
        It's easier to compute the statitstics in this way
        :return: a dictionary with the keys being the student id and the discipline id
        """
        student_dictionary = {}
    ...
    def get_failing_students(self):
        transformed_data_to_dictonary = deepcopy(self.__transform_repository_data_to_dictionary_with_keys_student_id_and_discipline_id())
        failing_students = []
        STUDENT_ID_INDEX = 0
    ...
    def get_students_with_the_best_school_situation_in_descending_order(self):
        transformed_data_to_dictionary = deepcopy(self.__transform_repository_data_to_dictionary_with_keys_student_id_and_discipline_id())
        ...
        for student_id_and_discipline in transformed_data_to_dictionary:
            ...
            if id_of_student not in student_average_grades.keys():
                #in case the student has no grades
